...
<div><button onclick="window.location.href='<?Php echo base_url(); ?>index.php/transcript/main_tps/get_details/15/<?php echo $admn_no;?>'">Download Excel</button> </div>
		...
		foreach($stu_result as $key=>$row)
		{
			...
			<tr>							
				<th colspan="3" style="font-size: 8px;">Subject</th>
                                <th style="font-size: 8px; width: 10%">Theory</th>
                                <th style="font-size: 8px; width: 10%">Sessional</th>
                                <th style="font-size: 8px; width: 10%">Practical</th>
			...
			foreach($row as $key1=>$row1)
			{
				...
				$total_points+=($row1['credit']*$row1['points']);
                                $re=$row1['grade'];
                                if($re!='F'){$res="PASS";}else{$res="FAIL";}

				?><tr>
                                <td colspan="3" style="font-size: 8px;"><?echo $key1;?></td>
                                <td style="font-size: 8px; width: 10%"><?echo $row1['theory'];?></td>
                                <td style="font-size: 8px; width: 10%"><?echo $row1['sessional'];?></td>
                                <td style="font-size: 8px; width: 10%"><?echo $row1['practical'];?></td>
                                <td style="font-size: 8px; width: 10%"><?echo $row1['total'];?></td>
